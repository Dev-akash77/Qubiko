      ...
      <div className="mobile_Screen cc">
        <div className="h-full w-full flex flex-col justify-between bg-gradient-to-b from-[#bfcaff] to-[#ff9afd] md:rounded-sm cc gap-[3rem]">
          ...
          <div className="flex flex-col justify-center items-center container gap-5">
            <button className="bg-blue w-full text-white rounded-full py-3 text-lg cursor-pointer" onClick={()=>{setislogin("Login")}}>
              Log in
            </button>
            <button className="bg-white w-full text-blue rounded-full py-3 text-lg cursor-pointer" onClick={()=>{setislogin("Sign up")}}>
              Sign up
            </button>
          </div>
        </div>
